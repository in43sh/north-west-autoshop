      ...
      <h2>Add a new car</h2>
        <form className="addnewcar-form" onSubmit={(event) => this.handleSubmit(event)}>
          <table>
              ...
              <tr>
              <td><p className="inputparagraph">Color: </p></td> <td><input onChange={(event) => this.handleChange("color", event)} className="input"/></td>
              </tr>
              <tr>
              <td><p className="inputparagraph">Year: </p></td> <td><input onChange={(event) => this.handleChange("year", event)} className="input"/></td>
              </tr>
              <tr>
              <td><p className="inputparagraph">Mileage: </p></td> <td><input onChange={(event) => this.handleChange("mileage", event)} className="input"/></td>
              </tr>
              <tr>
